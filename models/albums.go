...
func (o *Album) Tracks(mods ...qm.QueryMod) trackQuery {
	...
	queryMods = append(queryMods,
		qm.InnerJoin("\"track_albums\" on \"tracks\".\"id\" = \"track_albums\".\"track_id\""),
		qm.Where("\"track_albums\".\"album_id\"=?", o.ID),
	)
...
func (albumL) LoadTracks(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAlbum interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.Select("\"tracks\".*, \"a\".\"album_id\""),
		qm.From("\"tracks\""),
		qm.InnerJoin("\"track_albums\" as \"a\" on \"tracks\".\"id\" = \"a\".\"track_id\""),
		qm.WhereIn("\"a\".\"album_id\" in ?", args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// Sets related.R.Albums appropriately.
func (o *Album) AddTracks(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Track) error {
	...
	for _, rel := range related {
		query := "insert into \"track_albums\" (\"album_id\", \"track_id\") values ($1, $2)"
	...
	for _, rel := range related {
		if rel.R == nil {
			...
			rel.R.Albums = append(rel.R.Albums, o)
		}
	}
	return nil
}
...
func (o *Album) SetTracks(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Track) error {
	...
	removeTracksFromAlbumsSlice(o, related)
	if o.R != nil {
		o.R.Tracks = nil
	}
...
func removeTracksFromAlbumsSlice(o *Album, related []*Track) {
	for _, rel := range related {
		if rel.R == nil {
			continue
		}
		for i, ri := range rel.R.Albums {
			if o.ID != ri.ID {
				continue
			}
			...
			ln := len(rel.R.Albums)
			if ln > 1 && i < ln-1 {
				rel.R.Albums[i] = rel.R.Albums[ln-1]
			}
			rel.R.Albums = rel.R.Albums[:ln-1]
			break
		}
	}
}
